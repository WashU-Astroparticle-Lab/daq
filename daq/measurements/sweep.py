    ...
    def analyze(self, *, batch: bool = False, do_fit: bool = True, title: Optional[str] = None):
        ...
        def do_fit(fmin, fmax):
            if _do_fit:
                ...
                print("----------------")
                print(fr"fr = {port.fitresults['fr']} $\pm$ {port.fitresults['fr_err']} Hz")
                print(fr"Qi = {port.fitresults['Qi_dia_corr']} $\pm$ {port.fitresults['Qi_dia_corr_err']}")
                print(fr"Qc = {port.fitresults['Qc_dia_corr']} $\pm$ {port.fitresults['absQc_err']}")
                print(fr"Ql = {port.fitresults['Ql']} $\pm$ {port.fitresults['Ql_err']}")
